...
// This code manages the logic of the dog enemy.
public class Dog : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyAI.maxMovementPoints = 4; // Set the max movement points to 4
        ...
        ability = Resources.Load("Enemy Abilities/Bite"); // Instantiate the "Bite" object and set it as the ability
    }

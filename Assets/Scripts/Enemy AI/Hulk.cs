...
// Class for the hulk enemy
// This code manages the logic of the dog hulk.
public class Hulk : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyAI.health = 15; // Set the health to 15
        enemyAI.healthBar.maxValue = enemyAI.health; // Set the health bar's max value to the health
        enemyAI.maxMovementPoints = 1; // Set the max movement points to 1
        ...
        ability = Resources.Load("Enemy Abilities/Smash"); // Instantiate the "Bite" object and set it as the ability
    }
    ...
    public IEnumerator TurnActions()
    {
        ...
        { // If the hit box is touching the player,
            Instantiate(ability, enemyAI.player.transform); // Instantiate the ability on the player object
